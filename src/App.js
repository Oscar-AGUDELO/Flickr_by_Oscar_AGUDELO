...
const App = () => {
  ...
  const API = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=7dc498bf8c2a4a431362a1b49c8a301e&tags=" + keyword.Search + "&per_page=50&format=json&nojsoncallback=1";
